...
- 线上地址：`https://ea8df52043fd4121a761eed0a3e2c2c4.app.workbuddy.link/`（v0.6 系已上线）
...
6. 防作弊完整机制见 `spec/issues/08-leaderboard-security-ops.md`（含监控 SQL、拉黑 SOP、排查手册），改动前必读。
